...
const step1Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "Your rates here are 7% worse than your own site, and that's simply a mistake - you'll need to correct it if you want the bookings back.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "Honestly, I wouldn't read too much into it - a slow patch like this usually sorts itself out over the quarter.",
    partnerResponse:
...
const step2Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "The cleanest fix is to just put your direct website price up to match your Booking.com rate - then there's no gap to worry about.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "That's fair enough - if direct acquisition is the priority, taking the visibility hit here is a reasonable trade to make.",
    partnerResponse:
...
const step4Options: BranchingOption[] = [
  {
    ...
    playerDialogue:
      "BSB isn't applied to all of your bookings - it's only offered to a limited audience and constantly works to attract guests to your property. That partial room cost is paid by Booking.com on behalf of the guest, so you incur no additional fees and still receive the full room price you set.",
    partnerResponse:
...
const step5Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "Let's not leave this hanging - can you commit today to aligning your rates so we lock in the gains before next month?",
    partnerResponse:
