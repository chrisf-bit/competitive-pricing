...
const step1Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "Let's get straight to it - I've found a gap in your forward performance that we need to work through today. Your numbers are behind where they should be.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "The quickest win here would be to ease off that strict ADR discipline a little and let your prices flex down where demand is soft.",
    partnerResponse:
...
const step2Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "24% unsold is a serious amount of lost revenue, Claire - that's the kind of number that should really be setting off alarms on your side.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "The honest picture is that your performance here has been a bit underwhelming lately - there's clearly more you could be getting out of the channel.",
    partnerResponse:
...
const step3Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "The main thing is your visibility share is behind your peers - travelers just aren't seeing you as often as they should, and that's the real issue here.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "Honestly, being seen as the more affordable option wouldn't be a bad thing here - lean into it and the bookings will come.",
    partnerResponse:
...
const step4Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "Honestly, there's nothing to worry about with that program - it just works in the background. I wouldn't give it a second thought.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "Just lean on the Booking Sponsored Benefit - it'll carry your visibility all the way back on its own, guaranteed, so there's nothing else you need to do.",
    partnerResponse:
...
const step5Options: BranchingOption[] = [
  {
    ...
    partnerResponse:
      "Hmm, when you frame it around uncaptured search traffic, I see the logic. A targeted mobile adjustment... oh, sorry - actually we're not allowed to do that, it's against our brand rules and we could be fined. Is there another opaque or targeted deal we could use instead?",
  ...
  },
  {
    ...
    playerDialogue:
      "The cleanest way to close that 10% is a modest general reduction on your rates here - just enough to bring the search price in line.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "Switch on a mobile rate and I can promise your visibility jumps straight back up the results - the incentive buys you the placement, guaranteed.",
    partnerResponse:
...
const step6Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "Between us, plenty of partners run the mobile rate despite the rules and it's fine - I'd just switch it on quietly and not mention it to head office.",
    partnerResponse:
  ...
  },
  {
    ...
    playerDialogue:
      "Best thing is to go and confirm the rules with head office, then come back to me once you know what you're allowed to run.",
    partnerResponse:
...
const steps: BranchingStep[] = [
  ...
  },
  {
    ...
    partnerPrompt:
      "A targeted mobile adjustment... oh, sorry, I almost forgot - we're not allowed to do that, it's against our brand rules and we could be fined. Is there another opaque or targeted deal we can apply instead?",
