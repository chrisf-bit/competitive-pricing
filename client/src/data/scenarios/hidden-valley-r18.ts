...
const step3Options: BranchingOption[] = [
  ...
  },
  {
    ...
    playerDialogue:
      "The main thing is that your visibility share here is sitting behind your peer group - travelers aren't seeing you in their search results as often as they should be, and to my mind that's the real issue we need to be focused on solving today.",
    partnerResponse:
