 ...
 *
 * Light panel: off-white card (softer than stark white) with a defined
 * border so it grounds against the dark Round Select backdrop without
 * reading as a floating slab, and stays clean on the light Debrief.
 *
